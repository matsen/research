...
In additional to the usual academic professional service, I have started and continue to lead three initiatives to improve the research landscape in my field and at the Center.
Since 2009 I have run \url{http://phyloseminar.org/}, an online lecture series which has had 43 talks on a wide variety of phylogenetic inference and applications.
The seminar video recordings are on YouTube, and have been watched for almost 900 hours within the last year.
This year I started a sister project, \url{http://phylobabble.org/}, an electronic forum to discuss best practice and new developments in phylogenetics.
This year I also started \url{http://fredhutch.io/}, an initiative to facilitate education about and promote access to computational resources at the Fred Hutchinson Cancer Research Center.
Our current primary focus is on building out a full-featured \href{http://usegalaxy.org/}{Galaxy} instance that will be useful for Center researchers with no programming experience to analyze their data, and to develop tools for investigators to interact with their data in real time that can be used from within Galaxy.
